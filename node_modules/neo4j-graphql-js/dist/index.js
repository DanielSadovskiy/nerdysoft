      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 2:
            ...
            debug('%s', query);
            debug('%s', (0, _stringify["default"])(cypherParams, null, 2)); // TODO: Is this a 4.0 driver instance? Check bolt path for default database name and use that when creating the session
